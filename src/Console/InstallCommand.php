...
class InstallCommand extends Command
{
    ...
    protected function registerRoutes(): void
    {
        ...
        if (strpos($content, 'AuthAction::routes()') !== false) {
            $this->warning('Auth routes already registered. Skipping...');
            return;
        }

        $useStatement = "use App\\Actions\\AuthAction;";
        $registrationLine = "AuthAction::routes()->register(AuthAction::class);";
        ...
        // Add registration before the closing PHP tag or at the end
